package sg.edu.rp.c346.id21025553.demodialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnExercise3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // Extract the text entered by the user
                        double sum = Double.parseDouble(etNumber1.getText().toString()) + Double.parseDouble(etNumber2.getText().toString());
                        // Set the text to the TextView
        ...
        btnDemo5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Create the Time Picker Dialog - 24-Hour View
                /*TimePickerDialog myTimeDialog = new TimePickerDialog(MainActivity.this,
                        myTimeListener, 20, 00, true);
                myTimeDialog.show();*/

                /*// Create the Time Picker Dialog - AM/PM
                TimePickerDialog myTimeDialog = new TimePickerDialog(MainActivity.this,
